...
func (in *FluxConfig) DeepCopyInto(out *FluxConfig) {
	*out = *in
	...
	if in.AdditionalSecretResources != nil {
		in, out := &in.AdditionalSecretResources, &out.AdditionalSecretResources
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OCIRepositorySource) DeepCopyInto(out *OCIRepositorySource) {
	*out = *in
	in.Template.DeepCopyInto(&out.Template)
	if in.SecretResourceName != nil {
		in, out := &in.SecretResourceName, &out.SecretResourceName
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OCIRepositorySource.
func (in *OCIRepositorySource) DeepCopy() *OCIRepositorySource {
	if in == nil {
		return nil
	}
